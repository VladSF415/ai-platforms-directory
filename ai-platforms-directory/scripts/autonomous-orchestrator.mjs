...
const CONFIG = {
  ...
  tasks: {
    mass_discover: {
      ...
      frequency: 'daily',
      enabled: false // DISABLED: Focus on enriching existing platforms instead
    },
    discover: {
    ...
    enrich: {
      name: 'Platform Data Enrichment',
      script: 'data-enrichment.mjs',
      args: '--max=50', // Increased from 20 to 50 platforms per day
      frequency: 'daily',
      enabled: true
    },
    affiliate: {
    ...
    blog_enrich: {
      name: 'Blog Post Enrichment',
      script: 'blog-enrichment.mjs',
      args: '--max=10', // Enrich up to 10 blog posts per run
      frequency: 'daily',
      enabled: true
    },
    blog_generate: {
      name: 'Blog Generation (New Posts)',
      script: 'blog-generator.mjs',
      args: '--num=2 --type=category',
      frequency: 'weekly',
      enabled: false // DISABLED: Focus on enriching existing posts instead
    },
    recategorize: {
